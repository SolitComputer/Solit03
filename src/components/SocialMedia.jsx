...
export default function SocialMedia() {
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-16 md:py-24 bg-surface text-center">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-8 md:gap-12 max-w-4xl mx-auto">
        ...
        >
          <p className="mb-3 font-medium text-sm sm:text-base text-content-soft">
          ...
          <img
            src={igImg}
            alt="Instagram"
            className="w-40 sm:w-48 md:w-56 rounded-2xl border border-border shadow-soft group-hover:scale-105 hover:-translate-y-1 transition duration-300"
          />
        </Reveal>
