  ...
  <div className="max-w-5xl mx-auto relative z-10">
    ...
    <div className="flex justify-center mt-8">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        <p className="text-center text-gray-500 text-sm md:text-base max-w-2xl mx-auto mb-10">
          Prinsip yang menjadi fondasi setiap langkah kami dalam melayani pelanggan.
        </p>

        <div className="grid md:grid-cols-3 gap-6">
          {/* Kartu 1 */}
          <div className="group bg-white border border-gray-100 rounded-lg p-5 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all duration-300 text-center">
            ...
            <h3 className="text-base md:text-lg font-bold text-gray-800 mb-2">Kualitas Premium</h3>
            <p className="text-gray-500 leading-relaxed text-sm md:text-base">
          ...
          <div className="group bg-white border border-gray-100 rounded-lg p-5 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all duration-300 text-center">
            ...
            <h3 className="text-base md:text-lg font-bold text-gray-800 mb-2">Transparansi Penuh</h3>
            <p className="text-gray-500 leading-relaxed text-sm md:text-base">
          ...
          <div className="group bg-white border border-gray-100 rounded-lg p-5 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all duration-300 text-center">
            ...
            <h3 className="text-base md:text-lg font-bold text-gray-800 mb-2">Solusi Cerdas & Cepat</h3>
            <p className="text-gray-500 leading-relaxed text-sm md:text-base">
