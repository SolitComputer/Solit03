                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                    {socials.map((item, i) => (
                        <a
                            ...
                            className={`group relative rounded-xl p-4 md:p-5 bg-white shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden ${
                                item.name === "WhatsApp" ? "ring-2 ring-green-200" : ""
                            }`}
                        >
