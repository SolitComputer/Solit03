      ...
      <div className="bg-surface rounded-2xl shadow-2xl w-full max-w-md" style={{ maxHeight: "90vh", overflowY: "auto" }}>
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-content-muted">Digunakan untuk URL tag</p>
          </div>

          {/* Color */}
          <div className="space-y-2">
            <label className="text-xs font-semibold text-content-soft">Warna Tag</label>
          ...
          <div className={`border-2 rounded-xl p-4 ${c.lightBg} ${c.border}`}>
            <p className="text-xs font-semibold text-content-muted mb-2">Preview Tag</p>
            <div className="flex items-center gap-3">
              ...
              <p className="text-xs text-content-muted font-mono truncate">{form.slug || "slug-tag"}</p>
            </div>
          </div>
        ...
        <div className="relative">
          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base font-bold text-content">Hapus Tag</h2>
            </div>
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-content-muted mt-1">Kelola semua tag produk Anda</p>
        </div>
      ...
      <div className="bg-surface rounded-xl shadow-md border border-border overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="py-16 text-center">
            ...
            <p className="text-base font-semibold text-content-muted">{search ? "Tag tidak ditemukan" : "Belum ada tag"}</p>
            <p className="text-sm text-content-muted mt-1">{search ? "Coba dengan kata kunci lain" : "Klik tombol Tambah Tag untuk memulai"}</p>
          </div>
        ) : (
          <div className="divide-y divide-gray-100">
            {paginated.map(tag => {
              ...
              return (
                <div key={tag.id} className="flex items-center gap-4 px-5 py-4 hover:bg-gradient-to-r hover:from-gray-50 hover:to-white transition-all duration-200 group">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-content-muted font-mono">/{tag.slug}</p>
                  </div>
                  {tag.created_at && (
